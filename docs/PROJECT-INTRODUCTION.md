...
“AI 反诈劝阻”是一款面向证券投顾场景的 AI 话术训练器。它把投资理财诈骗中最难处理的一刻还原成一段可交互的企业微信对话：客户已经被荐股骗局深度影响，准备在下午三点前转出 30 万元；投资顾问只有 12 轮沟通机会，需要在不荐股、不说教、不激化矛盾的前提下，让客户重新审视这笔转账。

项目保留了游戏化外观，但核心不是“打败 AI”，而是训练真实业务中的三个能力：

1. 从有限信息中追问事实，而不是急着下结论。
2. 判断客户当前的情绪与信任程度，在正确时机使用正确话术。
3. 用客户自己说过的内容推动其思考，而不是照搬固定反诈模板。

AI 在这里负责把客户“演活”；命中什么方法、增加或减少多少信任度、最终落在哪种结局，都由程序规则确定。因此，同一句话在相同上下文中可以被解释、复现和测试，不由模型临场决定输赢。

## 2. 项目要解决的业务问题

荐股骗局中的客户往往同时受到沉没成本、群体认同、权威崇拜和限时催促影响。此时直接说“这是诈骗”通常没有效果，甚至会让客户把投顾归类为“不理解我、只想拦我赚钱的人”。

现实中的投资顾问还受到合规约束：只能通过追问、核实和风险提示引导客户，不能借劝阻之名再次荐股。传统课件能讲原则，却无法模拟客户的即时反击；固定选项式 H5 又会让训练退化成背答案。

本项目用自由文本对话解决这个缺口：客户会根据自己的经历、语言习惯、当前情绪和前文内容作出不同回应，训练者必须真正读懂对方，而不是从三个选项中猜正确答案。

## 3. 核心剧情

老陈 52 岁，在工厂干了 20 年。三个月前，他进入“启航财经·内部交流群”，跟随“王老师”做短线，账面上曾出现盈利，因此逐渐相信对方掌握“内部消息”。

当天，王老师要求老陈在下午三点前，把 30 万元转到指定账户统一操作。这笔钱原本准备用于孩子结婚。老陈已经从证券账户划走了 5 万元，并一直瞒着家人和自己的投资顾问。

投资顾问李经理收到风控提醒时，只知道客户账户刚转出一笔钱，并不知道启航财经、王老师、30 万元或下午三点的期限。玩家需要通过老陈的回答逐步挖出真相。这个信息差就是对局的起点，也是“扎根”判定的基础。

首页以老陈的微信会话列表完成剧情交代：

| 会话 | 透露的信息 |
|---|---|
| 李经理·投资顾问 | 投顾发现账户异动，正在尝试联系老陈 |
| 启航财经·内部交流群 | 王老师以“三点前统一操作”制造时间压力 |
| 招商银行 | 老陈已经支出 5 万元 |
| 老伴 | 这笔钱与孩子婚礼定金有关，家人并不知情 |
| 小雨 | 女儿已经查过公司并直接劝阻过，但没有成功 |
| 国家反诈中心 | 官方预警也曾出现，老陈仍未停止 |
...
每局通过对局 ID 确定性地选择一种老陈，同一局内始终保持一致。所有变体共享 30 万元、下午三点、王老师、已转 5 万元、家庭用途等剧情骨架，只改变个人经历、挡箭牌、软肋和表达方式。
...
玩家首先看到老陈的微信，而不是一段教程。六条会话把骗局、家庭用途、已发生的转账和既往劝阻失败全部交代清楚。系统同时在后台发起开局请求，降低进入聊天后的等待感。
